...
extension String {
    ...
    public static func count(_ string: String?) -> Int   {
        guard let string = string else {
            return 0
        }
        return string.count
    ...
    public static func random(using method: RandomStringMethod) -> String {
    ...
    static func randomLengthString(of length: Int, from base: String) -> String {
    ...
    static func randomWordsString(of count: Int, from base: String) -> String {
        var result: [String] = []
